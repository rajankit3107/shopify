...
exports.signup = (0, asyncHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const body = validation_1.signupSchema.safeParse(req.body);
    if (!body.success)
...
exports.login = (0, asyncHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const body = validation_1.loginSchema.safeParse(req.body);
    console.log(body);
    if (!body.success)
        throw apiError_1.ApiError.badRequest("Invalid credentials");
    console.log(body.success);
    const { email, password } = req.body;
    const payload = yield authservice.login(email, password);
